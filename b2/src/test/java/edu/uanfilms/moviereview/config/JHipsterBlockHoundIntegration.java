...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("edu.uanfilms.moviereview.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("edu.uanfilms.moviereview.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
