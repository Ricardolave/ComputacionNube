            ...
            <div class="container-fluid text-center" >
                    ...
                    <form>
                        <div class="input-group">
                            <input type="search" class="form-control rounded" placeholder="Buscar película por nombre, año, director o género" aria-label="Search" aria-describedby="search-addon"  name="Search"/>
